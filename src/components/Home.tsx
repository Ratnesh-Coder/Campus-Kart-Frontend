                ...
                <Link to={`/product/${data._id}`} key={data._id} className="group">
                  <div className="h-full flex flex-col border border-neutral-200 rounded-lg shadow-sm hover:shadow-2xl transition-shadow duration-300 bg-neutral-100 overflow-hidden">
                    ...
                    <div className="p-4 flex flex-col flex-grow">
                      <h2 className="font-bold text-lg truncate mb-1 text-neutral-700 group-hover:text-neutral-900 transition-colors">{data.title}</h2>
                      <p className="text-sm text-neutral-500 mb-2">{data.category}</p>
                      <p className="text-xl font-semibold text-neutral-900 mb-4 group-hover:text-neutral-900 transition-colors">₹{data.price.toLocaleString("en-IN")}</p>
                      <div className="flex-grow"></div>
                      <button className="w-full mt-2 bg-neutral-600 text-white py-2 rounded-md font-semibold hover:bg-neutral-900 transition-colors">View Details</button>
                    </div>
                  </div>
                </Link>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center">
              ...
              <h3 className="mt-5 text-xl font-bold text-neutral-800">Built on Trust</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-5 text-xl font-bold text-neutral-800">Campus Sustainability</h3>
...
const RupeeIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-neutral-700" viewBox="0 0 24 24" aria-hidden="true">
    <text x="50%" y="50%" fill="currentColor" fontSize="30" fontFamily="system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial" textAnchor="middle" dominantBaseline="central">₹</text>
  </svg>
);
